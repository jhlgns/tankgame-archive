...
#include "nuklear.h"
//#include <SDL_opengl.h> TODO(roepel)

NK_API struct nk_context*   nk_sdl_init(SDL_Window *win, nk_font *font);
...
nk_sdl_init(SDL_Window *win, nk_font *font)
{
    sdl.win = win;
    nk_init_default(&sdl.ctx, &font->handle);
